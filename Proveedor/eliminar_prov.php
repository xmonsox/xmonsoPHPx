...
<body>
    <div class="container mt-5">
        <h3 class="text-center" >Proveedor a eliminar</h3>
        <?php
        ...
        while ($row=$sql->fetch_array()) {
            ...
            <input class="form-control  border border-top-0 border border-end-0 border border-start-0 border border-success-subtle border border-3 
            border-opacity-50" type="text" name="telefono" value="<?= $row['v_producto'] ?>" required >
            ...
            if(!empty($_GET['id'])){
                ...
                if ($sql==1) {
                    ...
                    <div class="alert alert-info mt-5 text-center" role="alert">
                        !!Eliminado!! (Da click para Consultar los proveedores);
                    </div>
                    <div class="text-center mt-4">
