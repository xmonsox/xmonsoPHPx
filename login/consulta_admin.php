...
<body>
    <div class="container mt-5 mb-5 position-absolute top-50 start-50 translate-middle shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <div class="mt-5">
        <h3 class="text-center">Consulta administradores</h3>
        <table class="table table-bordered">
            ...
            <table class="table">
                ...
                <?php
                    ...
                    $consulta=$conexion->query("SELECT * FROM admin WHERE nombre LIKE '%$buscar%' or id_admin='$buscar' ORDER BY nombre ASC");	
                        }else{
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="modificar_admin.php?id=<?=$row['id_admin'] ?>" class="btn btn-outline-success btn-sm">Modificar</a></td>
                            <td><a href="eliminar_admin.php?id=<?=$row['id_admin'] ?>" class="btn btn-outline-danger btn-sm">Eliminar</a></td>
                        </tr>
                    <?php
                    }
                    ?>
