...
<div class="container-fluid">
    ...
    if(empty($_REQUEST)){
        ...
        <form class="mx-auto" method="post" action="">
            ...
            <a href="http://localhost/Taller_php/login/login.php" name="btnregistrar" class="btn btn-warning">Atras</a>
    ...
    <?php
        ...
        $conexion->query("insert into usuario(nombre, contraseña) values ('$usuario', '$password')");
        ?>
        <div class="container-fluid">
            <form class="mx-auto" method="post" action="">
